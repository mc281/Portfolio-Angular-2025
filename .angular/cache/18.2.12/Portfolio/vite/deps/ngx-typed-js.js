...
var NgxTypedJsComponent = class {
  ...
  ngAfterViewInit() {
    this.typed = new i(this.content.nativeElement.querySelector(".typing"), this.options);
...
NgxTypedJsComponent.ɵcmp = ɵɵdefineComponent({
